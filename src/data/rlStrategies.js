...
export const MARKDOWN_RULES = [
  ...
  { id: 'no-forced',      label: "Don't Force Any Line",                    short: 'No forced lines', showPct: false, showDepth: false, description: 'No mandatory markdowns — lets the system land at the optimal point.' },
  ...
  { id: 'layered',        label: 'Force Percentage + X% at Y%',             short: 'Layered',         showPct: true,  showDepth: true,  description: 'More products AND deeper discounts — layered clearance approach.' },
]
...
export const DEFAULT_GUARDRAIL_SETS = [
  {
    ...
    constraintLabel: 'Only Force Eligible Products',
  },
  {
    id: 2,
    label: 'Set B',
    ...
    constraintLabel: '40% of products at 30% off',
  },
]
