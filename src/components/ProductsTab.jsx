        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-gray-100">
              ...
              <th className="text-left px-4 py-3">
                <div className="font-semibold text-gray-800 text-xs">Category</div>
              </th>
              <th className="text-left px-4 py-3">
                <div className="font-semibold text-gray-800 text-xs">Country</div>
              </th>
              <th className="text-left px-4 py-3">
                <div className="font-semibold text-gray-800 text-xs">Campaign Tags</div>
              </th>
          ...
          <tbody>
            {products.map((p, i) => (
              <tr
                key={p.sku}
                className={`${i < products.length - 1 ? 'border-b border-gray-100' : ''} hover:bg-gray-50 transition-colors`}
              >
                ...
                <td className="px-4 py-4 text-gray-600">{p.country}</td>
